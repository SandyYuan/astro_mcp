...
ASTROQUERY_SERVICE_INFO = {   'alfalfa': {   'capabilities': ['query_region'],
    ...
    'sdss': {   'capabilities': [   'query_region',
                ...
                'example_queries': [   {   'description': "Get an image cutout by coordinates and radius (in degrees)",
                                           'query': "astroquery_query(service_name='sdss', query_type='get_images', ra=197.614, dec=1.903, radius=0.02)"},
